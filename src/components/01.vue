<template>
  <div>
    ...
    <div ref="box" class="box centered overflow-hidden fixed bottom-0 left-0 right-0 pointer-events-none z--1" ></div>
  </div>
</template>
...
import imgTop from '../assets/images/winter_top.jpg'
...
onMounted(async() => {
  ...
  renderer.setSize(window.innerWidth, window.innerHeight * 0.38)
